...
public class Sale extends Entity {
    ...
    private transient Payable payment;
    private Status        status;
    private List<SaleItem> items;

    public Sale() {
        super();
        this.saleDate      = LocalDateTime.now().minusDays(1);
        this.status        = Status.COMPLETED;
        this.paymentMethod = PaymentMethod.CASH;
        this.items         = new ArrayList<>();
    }

    @Override public String  getDisplayName() { return "Sale #" + getId() + " — Rs " + String.format("%.2f", grandTotal); }
    @Override public boolean isValid()        { return userId > 0 && grandTotal >= 0; }
    ...
    public void setPayment(Payable p)  { this.payment = p; }
