...
/**
 * Sale DAO — includes date-range queries and revenue aggregations.
 * OOP: Singleton, Generics, Lambda/Stream
 */
public class SaleDAO extends FileRepository<Sale> {
    ...
    /**
     * Returns the top-N medicines by quantity sold in a date range.
     * @return LinkedHashMap of medicine name → total quantity sold
     */
