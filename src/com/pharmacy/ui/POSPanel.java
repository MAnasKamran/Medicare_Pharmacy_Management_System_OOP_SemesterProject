...
public class POSPanel extends JPanel {
    ...
    private JComponent buildRightPanel() {
        ...
        checkout.setBorder(new EmptyBorder(16, 8, 16, PAD));
    ...
    private JPanel buildTotalsCard() {
        ...
        grandTotalLbl = new JLabel("Rs 0.00", SwingConstants.LEFT);
        ...
        grandTotalPanel.setBorder(BorderFactory.createCompoundBorder(
                ...
                new EmptyBorder(14, 16, 14, 16)));
        JLabel gtCaption = new JLabel("GRAND TOTAL", SwingConstants.LEFT);
        ...
        grandTotalPanel.setAlignmentX(Component.LEFT_ALIGNMENT);
        card.add(grandTotalPanel);

        card.add(Box.createVerticalStrut(10));
        changeLbl = new JLabel("Change: Rs 0.00", SwingConstants.LEFT);
        changeLbl.setFont(new Font("Segoe UI", Font.BOLD, 13));
        changeLbl.setForeground(SwingUtils.SUCCESS);
        changeLbl.setAlignmentX(Component.LEFT_ALIGNMENT);
        card.add(changeLbl);
