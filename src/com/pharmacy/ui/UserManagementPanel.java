...
public class UserManagementPanel extends JPanel {
    ...
    private void showRoleDetails() {
        ...
        sb.append("User: ").append(u.getDisplayName()).append("\n");
        sb.append("Username: ").append(u.getUsername()).append("\n");
        sb.append("Email: ").append(u.getEmail() != null ? u.getEmail() : "—").append("\n");
        sb.append("Status: ").append(u.isActive() ? "Active" : "Inactive").append("\n\n");
        sb.append("Role: ").append(u.getRole().getLabel()).append("\n");
        sb.append("Permissions:\n");
        sb.append("  Manage Inventory: ").append(u.getRole().canManageInventory()     ? "Yes" : "No").append("\n");
        sb.append("  Verify Prescriptions: ").append(u.getRole().canVerifyPrescriptions() ? "Yes" : "No").append("\n");
        sb.append("  Manage Users: ").append(u.getRole().canManageUsers()             ? "Yes" : "No").append("\n");
        if (u.isPharmacist() && u.getLicenseNumber() != null && !u.getLicenseNumber().isBlank()) {
            sb.append("License No.: ").append(u.getLicenseNumber()).append("\n");
        }
    ...
    private void showDialog(User existing) {
        ...
        if (!isNew) {
            ...
            licenseF.setText(existing.getLicenseNumber() != null ? existing.getLicenseNumber() : "");
        ...
        saveBtn.addActionListener(e -> {
            ...
            if (!lic.isBlank()) u.setLicenseNumber(lic);
